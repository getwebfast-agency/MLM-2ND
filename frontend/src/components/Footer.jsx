            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 mb-8">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm text-gray-400">
                            <li>
                                <a href="https://wa.me/918669977181?text=Hello%20Marathamall%20Support,%20I%20have%20a%20query%20and%20need%20help." target="_blank" rel="noopener noreferrer" className="hover:text-white flex items-center transition-colors">
